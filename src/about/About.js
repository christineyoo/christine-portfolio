    ...
    return (
      <><div id='about' className='about-flex'>
        ...
        <div className='about-flex-2'>
          ...
          <p>
            In addition to those skills, my previous work in education gives me
            an extra edge when it comes to developing solutions within a team
            since I learned the importance of setting a game plan before
            execution, adjusting quickly based on new developments, and
            streamlining communication amongst stakeholders. When I'm not in
            front of my computer, I like to explore California's beautiful coast
            with my husband and energetic Schnoodle, Fluffy.
          </p>
        </div>
      </div>
