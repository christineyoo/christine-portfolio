...
function Projects() {
  ...
  const goToNextSlide = () => setSlide((slide + 1) % 3)
          ...
          <div className={slide === 0 ? 'slide current' : 'slide'}>
            <div className='content'>
              ...
              <p>
                ...
                delete a review for any product. This app is for anyone who
                wants to shop for flowers and desserts online. The motivation
                behind this project was to understand the system design for an
                eCommerce application. The languages and technologies used to
                build Sweet Bloom include:
              </p>
              <ul>
                <li>HTML/CSS</li>
                <li>JavaScript</li>
          ...
          <div className={slide === 1 ? 'slide current' : 'slide'}>
            <div className='content'>
              ...
              <p>
                ...
                inter-collaboration. Users are able to perform CRUD operations
                on a post and also add or delete comments. The inspiration
                behind this app was to create a means of communication that is
                more streamlined and organized than traditional emails. The
                languages and technologies used to build Collab include:
              </p>
              <ul>
                <li>HTML/CSS</li>
                <li>JavaScript</li>
          ...
          <div className={slide === 2 ? 'slide current' : 'slide'}>
            <div className='content'>
              ...
              <p>
                ...
                (APOD) and learn more about outer space by searching for terms
                in the NASA image and video library. Users may simply search a
                term of interest and scroll through all that there is to learn
                about our fascinating universe! The purpose of this project was
                to practice implementing asynchronous code by fetching data from
                two different NASA API endpoints. The languages and technologies
                used to build LUMINA include:
              </p>
              <ul>
                <li>HTML/CSS</li>
                <li>JavaScript</li>
